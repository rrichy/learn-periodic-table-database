...
--
-- Name: properties types_properties; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT types_properties FOREIGN KEY (type_id) REFERENCES public.types(type_id);
